...
public class AlphavantageService implements StockQuotesService {
  ...
  // IMP: Do remember to write readable and maintainable code, There will be few
  // functions like
  ...
  private List<Candle> parseCandles(String stockCandlesString, LocalDate from, LocalDate to)
    ...
    AlphavantageDailyResponse alphavantageDailyResponse = objectMapper.readValue(stockCandlesString,
        AlphavantageDailyResponse.class);

    if (alphavantageDailyResponse.getCandles() == null || alphavantageDailyResponse.getCandles().isEmpty())
